...
All notable changes to AxonAI are documented here.
...
- **`AXONAI_*` env-var configurability for `DEFAULT_CONFIG`.** Override
...
- **LangGraph checkpoint resume** — opt-in via `--checkpoint`. State is saved
  ...
  `~/.axonai/cache/checkpoints/`. `--clear-checkpoints` resets them. (#594)
- **Persistent decision log** replacing the per-agent BM25 memory. Decisions
  ...
  a one-paragraph reflection. Override path with `AXONAI_MEMORY_LOG_PATH`.
...
- Cache and log directories moved to `~/.axonai/` to resolve Docker
...
- **Post-analysis report saving** — the framework writes per-section markdown
  ...
  completes.
- **Announcements panel** — fetches updates from `api.axonai.ai/v1/announcements`
...
- **Initial public release** of the AxonAI multi-agent trading
...
[0.2.4]: https://github.com/AxonAI/AxonAI/compare/v0.2.3...v0.2.4
[0.2.3]: https://github.com/AxonAI/AxonAI/compare/v0.2.2...v0.2.3
[0.2.2]: https://github.com/AxonAI/AxonAI/compare/v0.2.1...v0.2.2
[0.2.1]: https://github.com/AxonAI/AxonAI/compare/v0.2.0...v0.2.1
[0.2.0]: https://github.com/AxonAI/AxonAI/compare/v0.1.1...v0.2.0
[0.1.1]: https://github.com/AxonAI/AxonAI/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/AxonAI/AxonAI/releases/tag/v0.1.0
