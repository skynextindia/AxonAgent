...
header (see :func:`axonai.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`axonai.agents.utils.rating` is more
...
from axonai.agents.utils.rating import parse_rating
