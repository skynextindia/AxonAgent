...
from axonai.llm_clients import create_llm_client
...
from axonai.dataflows.utils import safe_ticker_component
from axonai.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from axonai.dataflows.config import set_config
...
class AxonAIGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "AxonAIStrategy_logs"
