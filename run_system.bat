...
.venv\Scripts\python.exe run.py --direct --symbol EURUSD --mt5-path "C:\Program Files\Eightcap Global MT5 Terminal\terminal64.exe" --hard-distance --risk-pct 1.1 --skip-falling-knife --skip-panic-buy --skip-session-buy
echo.
pause
goto menu
...
.venv\Scripts\python.exe run.py --direct --symbols "EURUSD,USDJPY" --mt5-path "C:\Program Files\Eightcap Global MT5 Terminal\terminal64.exe" --hard-distance --risk-pct 1.1 --skip-falling-knife --skip-panic-buy --skip-session-buy
echo.
pause
goto menu
