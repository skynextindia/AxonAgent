...
ann_sharpe = trade_sharpe * np.sqrt(760) # simple Trade Sharpe scaled to annual equivalent based on active series
...
print("\n--- 12-MONTH FULL YEAR BACKTEST PERFORMANCE METRICS ---")
