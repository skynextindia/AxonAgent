...
from axonai.agents.schemas import PortfolioDecision, PortfolioRating
from axonai.graph.reflection import Reflector
from axonai.graph.trading_graph import AxonAIGraph
from axonai.graph.propagation import Propagator
from axonai.agents.managers.portfolio_manager import create_portfolio_manager
...
class TestDeferredReflection:
    ...
    def test_fetch_returns_valid_ticker(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = AxonAIGraph._fetch_returns(mock_graph, "NVDA", "2026-01-05")
    ...
    def test_fetch_returns_too_recent(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = AxonAIGraph._fetch_returns(mock_graph, "NVDA", "2026-04-19")
    ...
    def test_fetch_returns_delisted(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            mock_ticker_cls.return_value = m
            raw, alpha, days = AxonAIGraph._fetch_returns(mock_graph, "XXXXXFAKE", "2026-01-10")
        assert raw is None and alpha is None and days is None
    ...
    # AxonAIGraph._resolve_benchmark — picks index for alpha calc
    ...
    def test_resolve_benchmark_explicit_override(self):
        ...
        assert AxonAIGraph._resolve_benchmark(mock_graph, "7203.T") == "QQQ"
        assert AxonAIGraph._resolve_benchmark(mock_graph, "NVDA") == "QQQ"
    ...
    def test_resolve_benchmark_suffix_map(self):
        ...
        assert AxonAIGraph._resolve_benchmark(mock_graph, "7203.T") == "^N225"
        assert AxonAIGraph._resolve_benchmark(mock_graph, "0700.HK") == "^HSI"
        assert AxonAIGraph._resolve_benchmark(mock_graph, "RELIANCE.NS") == "^NSEI"
        assert AxonAIGraph._resolve_benchmark(mock_graph, "AZN.L") == "^FTSE"
    ...
    def test_resolve_benchmark_us_ticker_defaults_to_spy(self):
        ...
        assert AxonAIGraph._resolve_benchmark(mock_graph, "NVDA") == "SPY"
        assert AxonAIGraph._resolve_benchmark(mock_graph, "AAPL") == "SPY"
    ...
    def test_resolve_benchmark_unknown_suffix_falls_back(self):
        ...
        assert AxonAIGraph._resolve_benchmark(mock_graph, "FAKE.XX") == "SPY"
        assert AxonAIGraph._resolve_benchmark(mock_graph, "BRK.B") == "SPY"
    ...
    # AxonAIGraph._resolve_pending_entries
    ...
    def test_resolve_skips_other_tickers(self, tmp_path):
        ...
        AxonAIGraph._resolve_pending_entries(mock_graph, "NVDA")
...
class TestLegacyRemoval:
    ...
    def test_financial_situation_memory_removed(self):
        ...
        import axonai.agents.utils.memory as m
    ...
    def test_reflect_and_remember_removed(self):
        """AxonAIGraph must not expose reflect_and_remember."""
        assert not hasattr(AxonAIGraph, "reflect_and_remember")
    ...
    def test_full_pipeline_no_regression(self, tmp_path):
        ...
        mock_graph._run_graph = functools.partial(
            AxonAIGraph._run_graph, mock_graph
        )
        AxonAIGraph.propagate(mock_graph, "NVDA", "2026-01-10")
