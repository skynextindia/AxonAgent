...
async def main():
    ...
    parser.add_argument("--mt5-path", type=str, default=None, help="Path to MT5 terminal executable")
    parser.add_argument("--login", type=int, default=None, help="MT5 login account")
    parser.add_argument("--password", type=str, default=None, help="MT5 password")
    parser.add_argument("--server", type=str, default=None, help="MT5 server")
